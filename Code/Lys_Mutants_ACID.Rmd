...
setwd("~/Dropbox/201710_SC_Supplementation_project/20180226_Lysine_Mutant_Analysis")
...
#This accounts for pathway intermediates, where REF is not present
if(features=="Pathway_Intermediates")
{
...
#If Pathway intermediates, this will median center. Otherwise, it will normalize to reference.
if(features=="Pathway_Intermediates")
{
  selected.heatmap<-centered.met.heatmap
  print("Pathway Intermediates, Median-Centering")
}else
{
  selected.heatmap<-tbl.heatmap
  print("Normalizing to Reference")
}
...
# create a png for the heat map
pdf(paste0("Heatmaps/",compiled.label,"_averages_heatmap_fixed.pdf"),       
    width = 7,
    height = 7,
    family = "Helvetica",
    bg = "transparent",
...
if(features=="Pathway_Intermediates")
{
  tbl.heatmap.avg<-centered.met.heatmap.avg
}
