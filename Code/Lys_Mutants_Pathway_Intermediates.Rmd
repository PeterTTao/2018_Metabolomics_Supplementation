...
compiled.label <- paste0(datePlot,"_SC_",experiment,"_",features,"_",analysis,"_All_Pathway_Intermediates")
...
long.tbl<-long.tbl[,-grep("Filter_CTRL",long.tbl$sampleClass)]
long.tbl<-long.tbl[,-grep("Media_CTRL",long.tbl$sampleClass)]
...
# unique(centered.met$sampleClass)
# index.1<-grep("LYS1_Deletion",centered.met$sampleClass)
# index.2<-grep("LYS2_Deletion",centered.met$sampleClass)
# index.3<-grep("LYS4_Deletion",centered.met$sampleClass)
# index.4<-grep("LYS9_Deletion",centered.met$sampleClass)
# index.5<-grep("LYS12_Deletion",centered.met$sampleClass)
# index.6<-grep("LYS20_LYS21",centered.met$sampleClass)
# 
# centered.met$sampleClass[index.1]<-"lys1"
# centered.met$sampleClass[index.2]<-"lys2"
# centered.met$sampleClass[index.3]<-"lys4"
# centered.met$sampleClass[index.4]<-"lys9"
# centered.met$sampleClass[index.5]<-"lys12"
# centered.met$sampleClass[index.6]<-"lys20_lys21"
# 
# centered.met<-centered.met[-c(grep("Filter_CTRL",centered.met$sampleClass)),]
# centered.met<-centered.met[-c(grep("Media_CTRL",centered.met$sampleClass)),]
# centered.met<-centered.met[-c(grep("WT_RCY308",centered.met$sampleClass)),]
# centered.met<-centered.met[-c(grep("LYS2_RCY256",centered.met$sampleClass)),]
# 
...
for(i in seq_along(unique(centered.met$featureName))) {
  boxplot.df <- centered.met %>%
    ...
    filter(sampleClass != "Filter_CTRL", sampleClass !="Media_CTRL")
...
pdf(file = paste0("Boxplots/",compiled.label, "_boxplots_fixed.pdf"), width = 17, height = 13)
...
colnames(norm.data.matrix)<-c("HO","lys1","lys12","lys2","lys20_lys21","lys4","lys9")

norm.data.matrix<-norm.data.matrix[,-c(1,2,7,11)]
